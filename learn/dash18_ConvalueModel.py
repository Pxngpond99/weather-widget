...
from data_learn import value_temperature
from data_learn import value_humidity
from data_learn import value_light
from data_learn import value_raindrop

from data_graph_learn import value_temperature_graph
from data_graph_learn import value_humidity_graph
from data_graph_learn import value_light_graph
...
app.layout = html.Div(
                children=[
                    ...
                    #         html.Div([
                    #             html.Div([
                    #                 html.Div(id="________"),
                    #                 dcc.Input(id='________', value='', type='text', placeholder='________',style=________, className="mx-auto"),
                    #                 dcc.Input(id='________', value='', type='text', placeholder='________',style=________, className="mx-auto"),
                    #                 dcc.Input(id='________', value='', type='text', placeholder='________',style=________, className="mx-auto"),
                    #                 html.Div(id="________"),
                    #                 dbc.Button([
...
# @app.callback(Output('________', 'children'),
#             [Input('________', 'value'),
#             Input('________', 'value'),
#             Input('________', 'value'),
#             Input("________","n_clicks")]
# )
...
#     return html.Div([
#                 html.Img(src=message, style=_________),
